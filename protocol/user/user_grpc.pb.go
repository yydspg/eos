...
const (
	User_GetDesignateUsers_FullMethodName             = "/eos.user.user/getDesignateUsers"
	User_UpdateUserInfo_FullMethodName                = "/eos.user.user/updateUserInfo"
	User_UpdateUserInfoEx_FullMethodName              = "/eos.user.user/updateUserInfoEx"
	User_SetGlobalRecvMessageOpt_FullMethodName       = "/eos.user.user/setGlobalRecvMessageOpt"
	User_GetGlobalRecvMessageOpt_FullMethodName       = "/eos.user.user/getGlobalRecvMessageOpt"
	User_AccountCheck_FullMethodName                  = "/eos.user.user/accountCheck"
	User_GetPaginationUsers_FullMethodName            = "/eos.user.user/getPaginationUsers"
	User_UserRegister_FullMethodName                  = "/eos.user.user/userRegister"
	User_GetAllUserID_FullMethodName                  = "/eos.user.user/getAllUserID"
	User_UserRegisterCount_FullMethodName             = "/eos.user.user/userRegisterCount"
	User_SubscribeOrCancelUsersStatus_FullMethodName  = "/eos.user.user/subscribeOrCancelUsersStatus"
	User_GetSubscribeUsersStatus_FullMethodName       = "/eos.user.user/getSubscribeUsersStatus"
	User_GetUserStatus_FullMethodName                 = "/eos.user.user/getUserStatus"
	User_SetUserStatus_FullMethodName                 = "/eos.user.user/setUserStatus"
	User_ProcessUserCommandAdd_FullMethodName         = "/eos.user.user/processUserCommandAdd"
	User_ProcessUserCommandUpdate_FullMethodName      = "/eos.user.user/processUserCommandUpdate"
	User_ProcessUserCommandDelete_FullMethodName      = "/eos.user.user/processUserCommandDelete"
	User_ProcessUserCommandGet_FullMethodName         = "/eos.user.user/processUserCommandGet"
	User_ProcessUserCommandGetAll_FullMethodName      = "/eos.user.user/processUserCommandGetAll"
	User_AddNotificationAccount_FullMethodName        = "/eos.user.user/addNotificationAccount"
	User_UpdateNotificationAccountInfo_FullMethodName = "/eos.user.user/updateNotificationAccountInfo"
	User_SearchNotificationAccount_FullMethodName     = "/eos.user.user/searchNotificationAccount"
	User_GetNotificationAccount_FullMethodName        = "/eos.user.user/getNotificationAccount"
	User_SortQuery_FullMethodName                     = "/eos.user.user/sortQuery"
	User_SetUserOnlineStatus_FullMethodName           = "/eos.user.user/setUserOnlineStatus"
	User_GetAllOnlineUsers_FullMethodName             = "/eos.user.user/getAllOnlineUsers"
	User_GetUserClientConfig_FullMethodName           = "/eos.user.user/getUserClientConfig"
	User_SetUserClientConfig_FullMethodName           = "/eos.user.user/setUserClientConfig"
	User_DelUserClientConfig_FullMethodName           = "/eos.user.user/delUserClientConfig"
	User_PageUserClientConfig_FullMethodName          = "/eos.user.user/pageUserClientConfig"
)
