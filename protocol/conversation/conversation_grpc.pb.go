...
const (
	Conversation_GetConversation_FullMethodName                         = "/eos.conversation.conversation/GetConversation"
	Conversation_GetSortedConversationList_FullMethodName               = "/eos.conversation.conversation/GetSortedConversationList"
	Conversation_GetAllConversations_FullMethodName                     = "/eos.conversation.conversation/GetAllConversations"
	Conversation_GetConversations_FullMethodName                        = "/eos.conversation.conversation/GetConversations"
	Conversation_SetConversation_FullMethodName                         = "/eos.conversation.conversation/SetConversation"
	Conversation_GetRecvMsgNotNotifyUserIDs_FullMethodName              = "/eos.conversation.conversation/GetRecvMsgNotNotifyUserIDs"
	Conversation_CreateSingleChatConversations_FullMethodName           = "/eos.conversation.conversation/CreateSingleChatConversations"
	Conversation_CreateGroupChatConversations_FullMethodName            = "/eos.conversation.conversation/CreateGroupChatConversations"
	Conversation_SetConversationMaxSeq_FullMethodName                   = "/eos.conversation.conversation/SetConversationMaxSeq"
	Conversation_SetConversationMinSeq_FullMethodName                   = "/eos.conversation.conversation/SetConversationMinSeq"
	Conversation_GetConversationIDs_FullMethodName                      = "/eos.conversation.conversation/GetConversationIDs"
	Conversation_SetConversations_FullMethodName                        = "/eos.conversation.conversation/SetConversations"
	Conversation_GetUserConversationIDsHash_FullMethodName              = "/eos.conversation.conversation/GetUserConversationIDsHash"
	Conversation_GetConversationsByConversationID_FullMethodName        = "/eos.conversation.conversation/GetConversationsByConversationID"
	Conversation_GetConversationOfflinePushUserIDs_FullMethodName       = "/eos.conversation.conversation/GetConversationOfflinePushUserIDs"
	Conversation_GetConversationNotReceiveMessageUserIDs_FullMethodName = "/eos.conversation.conversation/GetConversationNotReceiveMessageUserIDs"
	Conversation_UpdateConversation_FullMethodName                      = "/eos.conversation.conversation/UpdateConversation"
	Conversation_GetFullOwnerConversationIDs_FullMethodName             = "/eos.conversation.conversation/GetFullOwnerConversationIDs"
	Conversation_GetIncrementalConversation_FullMethodName              = "/eos.conversation.conversation/GetIncrementalConversation"
	Conversation_GetOwnerConversation_FullMethodName                    = "/eos.conversation.conversation/GetOwnerConversation"
	Conversation_GetConversationsNeedClearMsg_FullMethodName            = "/eos.conversation.conversation/GetConversationsNeedClearMsg"
	Conversation_GetNotNotifyConversationIDs_FullMethodName             = "/eos.conversation.conversation/GetNotNotifyConversationIDs"
	Conversation_GetPinnedConversationIDs_FullMethodName                = "/eos.conversation.conversation/GetPinnedConversationIDs"
	Conversation_ClearUserConversationMsg_FullMethodName                = "/eos.conversation.conversation/ClearUserConversationMsg"
	Conversation_UpdateConversationsByUser_FullMethodName               = "/eos.conversation.conversation/UpdateConversationsByUser"
)
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "eos.conversation.conversation",
