...
type PullMessageBySeqsReq struct {
	...
	Order         PullOrder              `protobuf:"varint,3,opt,name=order,proto3,enum=eos.sdkws.PullOrder" json:"order"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_sdkws_sdkws_proto_rawDesc = "" +
	"\n" +
	"\x11sdkws/sdkws.proto\x12\teos.sdkws\x1a\x1bwrapperspb/wrapperspb.proto\"\xdf\x04\n" +
	"\tGroupInfo\x12\x18\n" +
	...
	"\x12notificationUserID\x18\x11 \x01(\tR\x12notificationUserID\"\xa6\x03\n" +
	...
	"\x11applyMemberFriend\x18\t \x01(\v2\x18.eos.protobuf.Int32ValueR\x11applyMemberFriend\"\xff\x02\n" +
	...
	"\x10globalRecvMsgOpt\x18\a \x01(\x05R\x10globalRecvMsgOpt\"\x85\x02\n" +
	"\x0eUserInfoWithEx\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x125\n" +
	"\bnickname\x18\x02 \x01(\v2\x19.eos.protobuf.StringValueR\bnickname\x123\n" +
	"\afaceURL\x18\x03 \x01(\v2\x19.eos.protobuf.StringValueR\afaceURL\x12)\n" +
	"\x02ex\x18\x04 \x01(\v2\x19.eos.protobuf.StringValueR\x02ex\x12D\n" +
	"\x10globalRecvMsgOpt\x18\a \x01(\v2\x18.eos.protobuf.Int32ValueR\x10globalRecvMsgOpt\"\x8d\x02\n" +
	"\n" +
	"FriendInfo\x12 \n" +
	...
	"createTime\x123\n" +
	"\n" +
	"friendUser\x18\x04 \x01(\v2\x13.eos.sdkws.UserInfoR\n" +
	"friendUser\x12\x1c\n" +
	...
	"\bisPinned\x18\b \x01(\bR\bisPinned\"\xe4\x01\n" +
	"\tBlackInfo\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\x1e\n" +
	"\n" +
	"createTime\x18\x02 \x01(\x03R\n" +
	"createTime\x12?\n" +
	"\rblackUserInfo\x18\x03 \x01(\v2\x19.eos.sdkws.PublicUserInfoR\rblackUserInfo\x12\x1c\n" +
	"\taddSource\x18\x04 \x01(\x05R\taddSource\x12&\n" +
	"\x0eoperatorUserID\x18\x05 \x01(\tR\x0eoperatorUserID\x12\x0e\n" +
	"\x02ex\x18\x06 \x01(\tR\x02ex\"\x87\x03\n" +
	"\fGroupRequest\x125\n" +
	"\buserInfo\x18\x01 \x01(\v2\x19.eos.sdkws.PublicUserInfoR\buserInfo\x122\n" +
	...
	"handleTime\x12\x0e\n" +
	"\x02ex\x18\r \x01(\tR\x02ex\"\x8d\x01\n" +
	"\x14PullMessageBySeqsReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x121\n" +
	"\tseqRanges\x18\x02 \x03(\v2\x13.eos.sdkws.SeqRangeR\tseqRanges\x12*\n" +
	"\x05order\x18\x03 \x01(\x0e2\x14.eos.sdkws.PullOrderR\x05order\"l\n" +
	"\bSeqRange\x12&\n" +
	...
	"\x03num\x18\x04 \x01(\x03R\x03num\"`\n" +
	"\bPullMsgs\x12&\n" +
	"\x04Msgs\x18\x01 \x03(\v2\x12.eos.sdkws.MsgDataR\x04Msgs\x12\x14\n" +
	"\x05isEnd\x18\x02 \x01(\bR\x05isEnd\x12\x16\n" +
	"\x06endSeq\x18\x03 \x01(\x03R\x06endSeq\"\xe3\x02\n" +
	"\x15PullMessageBySeqsResp\x12>\n" +
	"\x04msgs\x18\x01 \x03(\v2*.eos.sdkws.PullMessageBySeqsResp.MsgsEntryR\x04msgs\x12b\n" +
	"\x10notificationMsgs\x18\x02 \x03(\v26.eos.sdkws.PullMessageBySeqsResp.NotificationMsgsEntryR\x10notificationMsgs\x1aL\n" +
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\x1aX\n" +
	"\x15NotificationMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\"&\n" +
	"\fGetMaxSeqReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\"\x89\x02\n" +
	"\rGetMaxSeqResp\x12?\n" +
	"\amaxSeqs\x18\x01 \x03(\v2%.eos.sdkws.GetMaxSeqResp.MaxSeqsEntryR\amaxSeqs\x12?\n" +
	"\aminSeqs\x18\x02 \x03(\v2%.eos.sdkws.GetMaxSeqResp.MinSeqsEntryR\aminSeqs\x1a:\n" +
	...
	"\bsendTime\x18\x03 \x01(\x03R\bsendTime\"\x9c\x06\n" +
	"\aMsgData\x12\x16\n" +
	...
	"\x06isRead\x18\x12 \x01(\bR\x06isRead\x129\n" +
	"\aoptions\x18\x13 \x03(\v2\x1f.eos.sdkws.MsgData.OptionsEntryR\aoptions\x12D\n" +
	"\x0fofflinePushInfo\x18\x14 \x01(\v2\x1a.eos.sdkws.OfflinePushInfoR\x0fofflinePushInfo\x12\"\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\xc8\x02\n" +
	"\fPushMessages\x125\n" +
	"\x04msgs\x18\x01 \x03(\v2!.eos.sdkws.PushMessages.MsgsEntryR\x04msgs\x12Y\n" +
	"\x10notificationMsgs\x18\x02 \x03(\v2-.eos.sdkws.PushMessages.NotificationMsgsEntryR\x10notificationMsgs\x1aL\n" +
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\x1aX\n" +
	"\x15NotificationMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\"\xb5\x01\n" +
	...
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12>\n" +
	"\n" +
	"memberList\x18\x03 \x03(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\n" +
	"memberList\x12$\n" +
	"\roperationTime\x18\x04 \x01(\x03R\roperationTime\x12F\n" +
	"\x0egroupOwnerUser\x18\x05 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x0egroupOwnerUser\x12.\n" +
	"\x12groupMemberVersion\x18\x06 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\a \x01(\tR\x14groupMemberVersionID\"\xf6\x01\n" +
	"\x10GroupInfoSetTips\x126\n" +
	"\x06opUser\x18\x01 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12\x1a\n" +
	"\bmuteTime\x18\x02 \x01(\x03R\bmuteTime\x12*\n" +
	"\x05group\x18\x03 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12.\n" +
	"\x12groupMemberVersion\x18\x04 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x05 \x01(\tR\x14groupMemberVersionID\"\xde\x01\n" +
	"\x14GroupInfoSetNameTips\x126\n" +
	"\x06opUser\x18\x01 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12*\n" +
	"\x05group\x18\x02 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12.\n" +
	"\x12groupMemberVersion\x18\x03 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x04 \x01(\tR\x14groupMemberVersionID\"\xe6\x01\n" +
	"\x1cGroupInfoSetAnnouncementTips\x126\n" +
	"\x06opUser\x18\x01 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12*\n" +
	"\x05group\x18\x02 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12.\n" +
	"\x12groupMemberVersion\x18\x03 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x04 \x01(\tR\x14groupMemberVersionID\"\x97\x01\n" +
	"\x18JoinGroupApplicationTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x127\n" +
	"\tapplicant\x18\x02 \x01(\v2\x19.eos.sdkws.PublicUserInfoR\tapplicant\x12\x16\n" +
	"\x06reqMsg\x18\x03 \x01(\tR\x06reqMsg\"\x82\x02\n" +
	"\x0eMemberQuitTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12:\n" +
	"\bquitUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\bquitUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x04 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x05 \x01(\tR\x14groupMemberVersionID\"\xc0\x01\n" +
	"\x1cGroupApplicationAcceptedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12\x1c\n" +
	...
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12D\n" +
	"\rnewGroupOwner\x18\x03 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\rnewGroupOwner\x12$\n" +
	"\roldGroupOwner\x18\x04 \x01(\tR\roldGroupOwner\x12$\n" +
	"\roperationTime\x18\x05 \x01(\x03R\roperationTime\x12L\n" +
	"\x11oldGroupOwnerInfo\x18\x06 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x11oldGroupOwnerInfo\x12.\n" +
	"\x12groupMemberVersion\x18\a \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\b \x01(\tR\x14groupMemberVersionID\"\xc8\x02\n" +
	"\x10MemberKickedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12F\n" +
	"\x0ekickedUserList\x18\x03 \x03(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x0ekickedUserList\x12$\n" +
	"\roperationTime\x18\x04 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x05 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x06 \x01(\tR\x14groupMemberVersionID\"\x8d\x03\n" +
	"\x11MemberInvitedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12H\n" +
	"\x0finvitedUserList\x18\x03 \x03(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x0finvitedUserList\x12$\n" +
	"\roperationTime\x18\x04 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x05 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x06 \x01(\tR\x14groupMemberVersionID\x12@\n" +
	"\vinviterUser\x18\a \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\vinviterUser\"\x89\x02\n" +
	"\x0fMemberEnterTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12@\n" +
	"\ventrantUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\ventrantUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x05 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x06 \x01(\tR\x14groupMemberVersionID\"\x9e\x01\n" +
	"\x12GroupDismissedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\"\xe6\x02\n" +
	"\x14GroupMemberMutedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12<\n" +
	"\tmutedUser\x18\x04 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\tmutedUser\x12\"\n" +
	"\fmutedSeconds\x18\x05 \x01(\rR\fmutedSeconds\x12.\n" +
	"\x12groupMemberVersion\x18\x06 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\a \x01(\tR\x14groupMemberVersionID\"\xc8\x02\n" +
	...
	"\tmutedUser\x18\x04 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\tmutedUser\x12.\n" +
	"\x12groupMemberVersion\x18\x05 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x06 \x01(\tR\x14groupMemberVersionID\"\xfe\x01\n" +
	"\x0eGroupMutedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x04 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x05 \x01(\tR\x14groupMemberVersionID\"\x84\x02\n" +
	"\x14GroupCancelMutedTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12.\n" +
	"\x12groupMemberVersion\x18\x04 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x05 \x01(\tR\x14groupMemberVersionID\"\xf4\x02\n" +
	"\x16GroupMemberInfoSetTips\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x126\n" +
	"\x06opUser\x18\x02 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\x06opUser\x12$\n" +
	"\roperationTime\x18\x03 \x01(\x03R\roperationTime\x12@\n" +
	"\vchangedUser\x18\x04 \x01(\v2\x1e.eos.sdkws.GroupMemberFullInfoR\vchangedUser\x12.\n" +
	"\x12groupMemberVersion\x18\x05 \x01(\x04R\x12groupMemberVersion\x122\n" +
	"\x14groupMemberVersionID\x18\x06 \x01(\tR\x14groupMemberVersionID\x12*\n" +
	...
	"fromUserID\x18\x01 \x01(\tR\n" +
	"fromUserID\x12\x1a\n" +
	"\btoUserID\x18\x02 \x01(\tR\btoUserID\"T\n" +
	"\x15FriendApplicationTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\"\xca\x01\n" +
	"\x1dFriendApplicationApprovedTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\x12\x1c\n" +
	"\thandleMsg\x18\x02 \x01(\tR\thandleMsg\x12$\n" +
	"\rfriendVersion\x18\x03 \x01(\x04R\rfriendVersion\x12(\n" +
	"\x0ffriendVersionID\x18\x04 \x01(\tR\x0ffriendVersionID\"z\n" +
	"\x1dFriendApplicationRejectedTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\x12\x1c\n" +
	"\thandleMsg\x18\x02 \x01(\tR\thandleMsg\"\xe9\x01\n" +
	"\x0fFriendAddedTips\x12-\n" +
	"\x06friend\x18\x01 \x01(\v2\x15.eos.sdkws.FriendInfoR\x06friend\x12$\n" +
	"\roperationTime\x18\x02 \x01(\x03R\roperationTime\x121\n" +
	"\x06opUser\x18\x03 \x01(\v2\x19.eos.sdkws.PublicUserInfoR\x06opUser\x12$\n" +
	"\rfriendVersion\x18\x04 \x01(\x04R\rfriendVersion\x12(\n" +
	"\x0ffriendVersionID\x18\x05 \x01(\tR\x0ffriendVersionID\"\xa0\x01\n" +
	"\x11FriendDeletedTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\x12$\n" +
	"\rfriendVersion\x18\x02 \x01(\x04R\rfriendVersion\x12(\n" +
	"\x0ffriendVersionID\x18\x03 \x01(\tR\x0ffriendVersionID\"M\n" +
	"\x0eBlackAddedTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\"O\n" +
	"\x10BlackDeletedTips\x12;\n" +
	"\ffromToUserID\x18\x01 \x01(\v2\x17.eos.sdkws.FromToUserIDR\ffromToUserID\"\xd2\x01\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12,\n" +
	"\x11onlinePlatformIDs\x18\x02 \x03(\x05R\x11onlinePlatformIDs\"_\n" +
	"\x17SubUserOnlineStatusTips\x12D\n" +
	"\vsubscribers\x18\x01 \x03(\v2\".eos.sdkws.SubUserOnlineStatusElemR\vsubscribers\"m\n" +
	...
	"\rPullOrderDesc\x10\x01B\x1fZ\x1dgithub.com/eos/protocol/sdkwsb\x06proto3"
...
var file_sdkws_sdkws_proto_goTypes = []any{
	(PullOrder)(0),                        // 0: eos.sdkws.PullOrder
	(*GroupInfo)(nil),                     // 1: eos.sdkws.GroupInfo
	(*GroupInfoForSet)(nil),               // 2: eos.sdkws.GroupInfoForSet
	(*GroupMemberFullInfo)(nil),           // 3: eos.sdkws.GroupMemberFullInfo
	(*PublicUserInfo)(nil),                // 4: eos.sdkws.PublicUserInfo
	(*UserInfo)(nil),                      // 5: eos.sdkws.UserInfo
	(*UserInfoWithEx)(nil),                // 6: eos.sdkws.UserInfoWithEx
	(*FriendInfo)(nil),                    // 7: eos.sdkws.FriendInfo
	(*BlackInfo)(nil),                     // 8: eos.sdkws.BlackInfo
	(*GroupRequest)(nil),                  // 9: eos.sdkws.GroupRequest
	(*FriendRequest)(nil),                 // 10: eos.sdkws.FriendRequest
	(*PullMessageBySeqsReq)(nil),          // 11: eos.sdkws.PullMessageBySeqsReq
	(*SeqRange)(nil),                      // 12: eos.sdkws.SeqRange
	(*PullMsgs)(nil),                      // 13: eos.sdkws.PullMsgs
	(*PullMessageBySeqsResp)(nil),         // 14: eos.sdkws.PullMessageBySeqsResp
	(*GetMaxSeqReq)(nil),                  // 15: eos.sdkws.GetMaxSeqReq
	(*GetMaxSeqResp)(nil),                 // 16: eos.sdkws.GetMaxSeqResp
	(*UserSendMsgResp)(nil),               // 17: eos.sdkws.UserSendMsgResp
	(*MsgData)(nil),                       // 18: eos.sdkws.MsgData
	(*PushMessages)(nil),                  // 19: eos.sdkws.PushMessages
	(*OfflinePushInfo)(nil),               // 20: eos.sdkws.OfflinePushInfo
	(*TipsComm)(nil),                      // 21: eos.sdkws.TipsComm
	(*GroupCreatedTips)(nil),              // 22: eos.sdkws.GroupCreatedTips
	(*GroupInfoSetTips)(nil),              // 23: eos.sdkws.GroupInfoSetTips
	(*GroupInfoSetNameTips)(nil),          // 24: eos.sdkws.GroupInfoSetNameTips
	(*GroupInfoSetAnnouncementTips)(nil),  // 25: eos.sdkws.GroupInfoSetAnnouncementTips
	(*JoinGroupApplicationTips)(nil),      // 26: eos.sdkws.JoinGroupApplicationTips
	(*MemberQuitTips)(nil),                // 27: eos.sdkws.MemberQuitTips
	(*GroupApplicationAcceptedTips)(nil),  // 28: eos.sdkws.GroupApplicationAcceptedTips
	(*GroupApplicationRejectedTips)(nil),  // 29: eos.sdkws.GroupApplicationRejectedTips
	(*GroupOwnerTransferredTips)(nil),     // 30: eos.sdkws.GroupOwnerTransferredTips
	(*MemberKickedTips)(nil),              // 31: eos.sdkws.MemberKickedTips
	(*MemberInvitedTips)(nil),             // 32: eos.sdkws.MemberInvitedTips
	(*MemberEnterTips)(nil),               // 33: eos.sdkws.MemberEnterTips
	(*GroupDismissedTips)(nil),            // 34: eos.sdkws.GroupDismissedTips
	(*GroupMemberMutedTips)(nil),          // 35: eos.sdkws.GroupMemberMutedTips
	(*GroupMemberCancelMutedTips)(nil),    // 36: eos.sdkws.GroupMemberCancelMutedTips
	(*GroupMutedTips)(nil),                // 37: eos.sdkws.GroupMutedTips
	(*GroupCancelMutedTips)(nil),          // 38: eos.sdkws.GroupCancelMutedTips
	(*GroupMemberInfoSetTips)(nil),        // 39: eos.sdkws.GroupMemberInfoSetTips
	(*FriendApplication)(nil),             // 40: eos.sdkws.FriendApplication
	(*FromToUserID)(nil),                  // 41: eos.sdkws.FromToUserID
	(*FriendApplicationTips)(nil),         // 42: eos.sdkws.FriendApplicationTips
	(*FriendApplicationApprovedTips)(nil), // 43: eos.sdkws.FriendApplicationApprovedTips
	(*FriendApplicationRejectedTips)(nil), // 44: eos.sdkws.FriendApplicationRejectedTips
	(*FriendAddedTips)(nil),               // 45: eos.sdkws.FriendAddedTips
	(*FriendDeletedTips)(nil),             // 46: eos.sdkws.FriendDeletedTips
	(*BlackAddedTips)(nil),                // 47: eos.sdkws.BlackAddedTips
	(*BlackDeletedTips)(nil),              // 48: eos.sdkws.BlackDeletedTips
	(*FriendInfoChangedTips)(nil),         // 49: eos.sdkws.FriendInfoChangedTips
	(*UserInfoUpdatedTips)(nil),           // 50: eos.sdkws.UserInfoUpdatedTips
	(*UserStatusChangeTips)(nil),          // 51: eos.sdkws.UserStatusChangeTips
	(*UserCommandAddTips)(nil),            // 52: eos.sdkws.UserCommandAddTips
	(*UserCommandUpdateTips)(nil),         // 53: eos.sdkws.UserCommandUpdateTips
	(*UserCommandDeleteTips)(nil),         // 54: eos.sdkws.UserCommandDeleteTips
	(*ConversationUpdateTips)(nil),        // 55: eos.sdkws.ConversationUpdateTips
	(*ConversationSetPrivateTips)(nil),    // 56: eos.sdkws.ConversationSetPrivateTips
	(*ConversationHasReadTips)(nil),       // 57: eos.sdkws.ConversationHasReadTips
	(*NotificationElem)(nil),              // 58: eos.sdkws.NotificationElem
	(*Seqs)(nil),                          // 59: eos.sdkws.seqs
	(*DeleteMessageTips)(nil),             // 60: eos.sdkws.DeleteMessageTips
	(*RevokeMsgTips)(nil),                 // 61: eos.sdkws.RevokeMsgTips
	(*MessageRevokedContent)(nil),         // 62: eos.sdkws.MessageRevokedContent
	(*ClearConversationTips)(nil),         // 63: eos.sdkws.ClearConversationTips
	(*DeleteMsgsTips)(nil),                // 64: eos.sdkws.DeleteMsgsTips
	(*MarkAsReadTips)(nil),                // 65: eos.sdkws.MarkAsReadTips
	(*SetAppBackgroundStatusReq)(nil),     // 66: eos.sdkws.SetAppBackgroundStatusReq
	(*SetAppBackgroundStatusResp)(nil),    // 67: eos.sdkws.SetAppBackgroundStatusResp
	(*ProcessUserCommand)(nil),            // 68: eos.sdkws.ProcessUserCommand
	(*RequestPagination)(nil),             // 69: eos.sdkws.RequestPagination
	(*FriendsInfoUpdateTips)(nil),         // 70: eos.sdkws.FriendsInfoUpdateTips
	(*SubUserOnlineStatusElem)(nil),       // 71: eos.sdkws.SubUserOnlineStatusElem
	(*SubUserOnlineStatusTips)(nil),       // 72: eos.sdkws.SubUserOnlineStatusTips
	(*SubUserOnlineStatus)(nil),           // 73: eos.sdkws.SubUserOnlineStatus
	(*StreamMsgTips)(nil),                 // 74: eos.sdkws.StreamMsgTips
	nil,                                   // 75: eos.sdkws.PullMessageBySeqsResp.MsgsEntry
	nil,                                   // 76: eos.sdkws.PullMessageBySeqsResp.NotificationMsgsEntry
	nil,                                   // 77: eos.sdkws.GetMaxSeqResp.MaxSeqsEntry
	nil,                                   // 78: eos.sdkws.GetMaxSeqResp.MinSeqsEntry
	nil,                                   // 79: eos.sdkws.MsgData.OptionsEntry
	nil,                                   // 80: eos.sdkws.PushMessages.MsgsEntry
	nil,                                   // 81: eos.sdkws.PushMessages.NotificationMsgsEntry
	(*wrapperspb.StringValue)(nil),        // 82: eos.protobuf.StringValue
	(*wrapperspb.Int32Value)(nil),         // 83: eos.protobuf.Int32Value
}
var file_sdkws_sdkws_proto_depIdxs = []int32{
	82, // 0: eos.sdkws.GroupInfoForSet.ex:type_name -> eos.protobuf.StringValue
	83, // 1: eos.sdkws.GroupInfoForSet.needVerification:type_name -> eos.protobuf.Int32Value
	83, // 2: eos.sdkws.GroupInfoForSet.lookMemberInfo:type_name -> eos.protobuf.Int32Value
	83, // 3: eos.sdkws.GroupInfoForSet.applyMemberFriend:type_name -> eos.protobuf.Int32Value
	82, // 4: eos.sdkws.UserInfoWithEx.nickname:type_name -> eos.protobuf.StringValue
	82, // 5: eos.sdkws.UserInfoWithEx.faceURL:type_name -> eos.protobuf.StringValue
	82, // 6: eos.sdkws.UserInfoWithEx.ex:type_name -> eos.protobuf.StringValue
	83, // 7: eos.sdkws.UserInfoWithEx.globalRecvMsgOpt:type_name -> eos.protobuf.Int32Value
	5,  // 8: eos.sdkws.FriendInfo.friendUser:type_name -> eos.sdkws.UserInfo
	4,  // 9: eos.sdkws.BlackInfo.blackUserInfo:type_name -> eos.sdkws.PublicUserInfo
	4,  // 10: eos.sdkws.GroupRequest.userInfo:type_name -> eos.sdkws.PublicUserInfo
	1,  // 11: eos.sdkws.GroupRequest.groupInfo:type_name -> eos.sdkws.GroupInfo
	12, // 12: eos.sdkws.PullMessageBySeqsReq.seqRanges:type_name -> eos.sdkws.SeqRange
	0,  // 13: eos.sdkws.PullMessageBySeqsReq.order:type_name -> eos.sdkws.PullOrder
	18, // 14: eos.sdkws.PullMsgs.Msgs:type_name -> eos.sdkws.MsgData
	75, // 15: eos.sdkws.PullMessageBySeqsResp.msgs:type_name -> eos.sdkws.PullMessageBySeqsResp.MsgsEntry
	76, // 16: eos.sdkws.PullMessageBySeqsResp.notificationMsgs:type_name -> eos.sdkws.PullMessageBySeqsResp.NotificationMsgsEntry
	77, // 17: eos.sdkws.GetMaxSeqResp.maxSeqs:type_name -> eos.sdkws.GetMaxSeqResp.MaxSeqsEntry
	78, // 18: eos.sdkws.GetMaxSeqResp.minSeqs:type_name -> eos.sdkws.GetMaxSeqResp.MinSeqsEntry
	79, // 19: eos.sdkws.MsgData.options:type_name -> eos.sdkws.MsgData.OptionsEntry
	20, // 20: eos.sdkws.MsgData.offlinePushInfo:type_name -> eos.sdkws.OfflinePushInfo
	80, // 21: eos.sdkws.PushMessages.msgs:type_name -> eos.sdkws.PushMessages.MsgsEntry
	81, // 22: eos.sdkws.PushMessages.notificationMsgs:type_name -> eos.sdkws.PushMessages.NotificationMsgsEntry
	1,  // 23: eos.sdkws.GroupCreatedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 24: eos.sdkws.GroupCreatedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 25: eos.sdkws.GroupCreatedTips.memberList:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 26: eos.sdkws.GroupCreatedTips.groupOwnerUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 27: eos.sdkws.GroupInfoSetTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 28: eos.sdkws.GroupInfoSetTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 29: eos.sdkws.GroupInfoSetNameTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 30: eos.sdkws.GroupInfoSetNameTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 31: eos.sdkws.GroupInfoSetAnnouncementTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 32: eos.sdkws.GroupInfoSetAnnouncementTips.group:type_name -> eos.sdkws.GroupInfo
	1,  // 33: eos.sdkws.JoinGroupApplicationTips.group:type_name -> eos.sdkws.GroupInfo
	4,  // 34: eos.sdkws.JoinGroupApplicationTips.applicant:type_name -> eos.sdkws.PublicUserInfo
	1,  // 35: eos.sdkws.MemberQuitTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 36: eos.sdkws.MemberQuitTips.quitUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 37: eos.sdkws.GroupApplicationAcceptedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 38: eos.sdkws.GroupApplicationAcceptedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 39: eos.sdkws.GroupApplicationRejectedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 40: eos.sdkws.GroupApplicationRejectedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 41: eos.sdkws.GroupOwnerTransferredTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 42: eos.sdkws.GroupOwnerTransferredTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 43: eos.sdkws.GroupOwnerTransferredTips.newGroupOwner:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 44: eos.sdkws.GroupOwnerTransferredTips.oldGroupOwnerInfo:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 45: eos.sdkws.MemberKickedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 46: eos.sdkws.MemberKickedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 47: eos.sdkws.MemberKickedTips.kickedUserList:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 48: eos.sdkws.MemberInvitedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 49: eos.sdkws.MemberInvitedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 50: eos.sdkws.MemberInvitedTips.invitedUserList:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 51: eos.sdkws.MemberInvitedTips.inviterUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 52: eos.sdkws.MemberEnterTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 53: eos.sdkws.MemberEnterTips.entrantUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 54: eos.sdkws.GroupDismissedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 55: eos.sdkws.GroupDismissedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 56: eos.sdkws.GroupMemberMutedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 57: eos.sdkws.GroupMemberMutedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 58: eos.sdkws.GroupMemberMutedTips.mutedUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 59: eos.sdkws.GroupMemberCancelMutedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 60: eos.sdkws.GroupMemberCancelMutedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 61: eos.sdkws.GroupMemberCancelMutedTips.mutedUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 62: eos.sdkws.GroupMutedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 63: eos.sdkws.GroupMutedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 64: eos.sdkws.GroupCancelMutedTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 65: eos.sdkws.GroupCancelMutedTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	1,  // 66: eos.sdkws.GroupMemberInfoSetTips.group:type_name -> eos.sdkws.GroupInfo
	3,  // 67: eos.sdkws.GroupMemberInfoSetTips.opUser:type_name -> eos.sdkws.GroupMemberFullInfo
	3,  // 68: eos.sdkws.GroupMemberInfoSetTips.changedUser:type_name -> eos.sdkws.GroupMemberFullInfo
	41, // 69: eos.sdkws.FriendApplicationTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 70: eos.sdkws.FriendApplicationApprovedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 71: eos.sdkws.FriendApplicationRejectedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	7,  // 72: eos.sdkws.FriendAddedTips.friend:type_name -> eos.sdkws.FriendInfo
	4,  // 73: eos.sdkws.FriendAddedTips.opUser:type_name -> eos.sdkws.PublicUserInfo
	41, // 74: eos.sdkws.FriendDeletedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 75: eos.sdkws.BlackAddedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 76: eos.sdkws.BlackDeletedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 77: eos.sdkws.FriendInfoChangedTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	41, // 78: eos.sdkws.FriendsInfoUpdateTips.fromToUserID:type_name -> eos.sdkws.FromToUserID
	71, // 79: eos.sdkws.SubUserOnlineStatusTips.subscribers:type_name -> eos.sdkws.SubUserOnlineStatusElem
	13, // 80: eos.sdkws.PullMessageBySeqsResp.MsgsEntry.value:type_name -> eos.sdkws.PullMsgs
	13, // 81: eos.sdkws.PullMessageBySeqsResp.NotificationMsgsEntry.value:type_name -> eos.sdkws.PullMsgs
	13, // 82: eos.sdkws.PushMessages.MsgsEntry.value:type_name -> eos.sdkws.PullMsgs
	13, // 83: eos.sdkws.PushMessages.NotificationMsgsEntry.value:type_name -> eos.sdkws.PullMsgs
