...
const file_third_third_proto_rawDesc = "" +
	"\n" +
	"\x11third/third.proto\x12\teos.third\x1a\x11sdkws/sdkws.proto\"5\n" +
	"\tKeyValues\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\"\x96\x01\n" +
	"\bSignPart\x12\x1e\n" +
	"\n" +
	"partNumber\x18\x01 \x01(\x05R\n" +
	"partNumber\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12*\n" +
	"\x05query\x18\x03 \x03(\v2\x14.eos.third.KeyValuesR\x05query\x12,\n" +
	"\x06header\x18\x04 \x03(\v2\x14.eos.third.KeyValuesR\x06header\"\xa6\x01\n" +
	"\rAuthSignParts\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12*\n" +
	"\x05query\x18\x02 \x03(\v2\x14.eos.third.KeyValuesR\x05query\x12,\n" +
	"\x06header\x18\x03 \x03(\v2\x14.eos.third.KeyValuesR\x06header\x12)\n" +
	"\x05parts\x18\x04 \x03(\v2\x13.eos.third.SignPartR\x05parts\"\x0e\n" +
	"\fPartLimitReq\"s\n" +
	"\rPartLimitResp\x12 \n" +
	...
	"\turlPrefix\x18\b \x01(\tR\turlPrefix\"\x92\x01\n" +
	"\n" +
	"UploadInfo\x12\x1a\n" +
	"\buploadID\x18\x01 \x01(\tR\buploadID\x12\x1a\n" +
	"\bpartSize\x18\x02 \x01(\x03R\bpartSize\x12,\n" +
	"\x04sign\x18\x03 \x01(\v2\x18.eos.third.AuthSignPartsR\x04sign\x12\x1e\n" +
	"\n" +
	"expireTime\x18\x04 \x01(\x03R\n" +
	"expireTime\"^\n" +
	"\x1bInitiateMultipartUploadResp\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12-\n" +
	"\x06upload\x18\x02 \x01(\v2\x15.eos.third.UploadInfoR\x06upload\"K\n" +
	"\vAuthSignReq\x12\x1a\n" +
	"\buploadID\x18\x01 \x01(\tR\buploadID\x12 \n" +
	"\vpartNumbers\x18\x02 \x03(\x05R\vpartNumbers\"\xa5\x01\n" +
	"\fAuthSignResp\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12*\n" +
	"\x05query\x18\x02 \x03(\v2\x14.eos.third.KeyValuesR\x05query\x12,\n" +
	"\x06header\x18\x03 \x03(\v2\x14.eos.third.KeyValuesR\x06header\x12)\n" +
	"\x05parts\x18\x04 \x03(\v2\x13.eos.third.SignPartR\x05parts\"\xb8\x01\n" +
	...
	"\x03url\x18\x01 \x01(\tR\x03url\"\x96\x01\n" +
	"\fAccessURLReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x05query\x18\x02 \x03(\v2\".eos.third.AccessURLReq.QueryEntryR\x05query\x1a8\n" +
	"\n" +
	"QueryEntry\x12\x10\n" +
	...
	"\babsolute\x18\x06 \x01(\bR\babsolute\"\xc0\x02\n" +
	"\x14InitiateFormDataResp\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12\x12\n" +
	"\x04file\x18\x03 \x01(\tR\x04file\x12,\n" +
	"\x06header\x18\x04 \x03(\v2\x14.eos.third.KeyValuesR\x06header\x12I\n" +
	"\bformData\x18\x05 \x03(\v2-.eos.third.InitiateFormDataResp.FormDataEntryR\bformData\x12\x18\n" +
	...
	"\bfileURLs\x18\x02 \x03(\v2\x12.eos.third.fileURLR\bfileURLs\x12\"\n" +
	...
	"\aversion\x18\n" +
	" \x01(\tR\aversion\"X\n" +
	"\x0eSearchLogsResp\x120\n" +
	"\tlogsInfos\x18\x01 \x03(\v2\x12.eos.third.LogInfoR\tlogsInfos\x12\x14\n" +
	"\x05total\x18\x02 \x01(\rR\x05total2\xb8\b\n" +
	"\x05third\x12>\n" +
	"\tPartLimit\x12\x17.eos.third.PartLimitReq\x1a\x18.eos.third.PartLimitResp\x12;\n" +
	"\bPartSize\x12\x16.eos.third.PartSizeReq\x1a\x17.eos.third.PartSizeResp\x12h\n" +
	"\x17InitiateMultipartUpload\x12%.eos.third.InitiateMultipartUploadReq\x1a&.eos.third.InitiateMultipartUploadResp\x12;\n" +
	"\bAuthSign\x12\x16.eos.third.AuthSignReq\x1a\x17.eos.third.AuthSignResp\x12h\n" +
	"\x17CompleteMultipartUpload\x12%.eos.third.CompleteMultipartUploadReq\x1a&.eos.third.CompleteMultipartUploadResp\x12>\n" +
	"\tAccessURL\x12\x17.eos.third.AccessURLReq\x1a\x18.eos.third.AccessURLResp\x12S\n" +
	"\x10InitiateFormData\x12\x1e.eos.third.InitiateFormDataReq\x1a\x1f.eos.third.InitiateFormDataResp\x12S\n" +
	"\x10CompleteFormData\x12\x1e.eos.third.CompleteFormDataReq\x1a\x1f.eos.third.CompleteFormDataResp\x12Y\n" +
	"\x12DeleteOutdatedData\x12 .eos.third.DeleteOutdatedDataReq\x1a!.eos.third.DeleteOutdatedDataResp\x12M\n" +
	"\x0eFcmUpdateToken\x12\x1c.eos.third.FcmUpdateTokenReq\x1a\x1d.eos.third.FcmUpdateTokenResp\x12D\n" +
	"\vSetAppBadge\x12\x19.eos.third.SetAppBadgeReq\x1a\x1a.eos.third.SetAppBadgeResp\x12A\n" +
	"\n" +
	"UploadLogs\x12\x18.eos.third.UploadLogsReq\x1a\x19.eos.third.UploadLogsResp\x12A\n" +
	"\n" +
	"DeleteLogs\x12\x18.eos.third.DeleteLogsReq\x1a\x19.eos.third.DeleteLogsResp\x12A\n" +
	"\n" +
	"SearchLogs\x12\x18.eos.third.SearchLogsReq\x1a\x19.eos.third.SearchLogsRespB\x1fZ\x1dgithub.com/eos/protocol/thirdb\x06proto3"
...
var file_third_third_proto_goTypes = []any{
	(*KeyValues)(nil),                   // 0: eos.third.KeyValues
	(*SignPart)(nil),                    // 1: eos.third.SignPart
	(*AuthSignParts)(nil),               // 2: eos.third.AuthSignParts
	(*PartLimitReq)(nil),                // 3: eos.third.PartLimitReq
	(*PartLimitResp)(nil),               // 4: eos.third.PartLimitResp
	(*PartSizeReq)(nil),                 // 5: eos.third.PartSizeReq
	(*PartSizeResp)(nil),                // 6: eos.third.PartSizeResp
	(*InitiateMultipartUploadReq)(nil),  // 7: eos.third.InitiateMultipartUploadReq
	(*UploadInfo)(nil),                  // 8: eos.third.UploadInfo
	(*InitiateMultipartUploadResp)(nil), // 9: eos.third.InitiateMultipartUploadResp
	(*AuthSignReq)(nil),                 // 10: eos.third.AuthSignReq
	(*AuthSignResp)(nil),                // 11: eos.third.AuthSignResp
	(*CompleteMultipartUploadReq)(nil),  // 12: eos.third.CompleteMultipartUploadReq
	(*CompleteMultipartUploadResp)(nil), // 13: eos.third.CompleteMultipartUploadResp
	(*AccessURLReq)(nil),                // 14: eos.third.AccessURLReq
	(*AccessURLResp)(nil),               // 15: eos.third.AccessURLResp
	(*InitiateFormDataReq)(nil),         // 16: eos.third.InitiateFormDataReq
	(*InitiateFormDataResp)(nil),        // 17: eos.third.InitiateFormDataResp
	(*CompleteFormDataReq)(nil),         // 18: eos.third.CompleteFormDataReq
	(*CompleteFormDataResp)(nil),        // 19: eos.third.CompleteFormDataResp
	(*DeleteOutdatedDataReq)(nil),       // 20: eos.third.DeleteOutdatedDataReq
	(*DeleteOutdatedDataResp)(nil),      // 21: eos.third.DeleteOutdatedDataResp
	(*FcmUpdateTokenReq)(nil),           // 22: eos.third.FcmUpdateTokenReq
	(*FcmUpdateTokenResp)(nil),          // 23: eos.third.FcmUpdateTokenResp
	(*SetAppBadgeReq)(nil),              // 24: eos.third.SetAppBadgeReq
	(*SetAppBadgeResp)(nil),             // 25: eos.third.SetAppBadgeResp
	(*FileURL)(nil),                     // 26: eos.third.fileURL
	(*UploadLogsReq)(nil),               // 27: eos.third.UploadLogsReq
	(*UploadLogsResp)(nil),              // 28: eos.third.UploadLogsResp
	(*DeleteLogsReq)(nil),               // 29: eos.third.DeleteLogsReq
	(*DeleteLogsResp)(nil),              // 30: eos.third.DeleteLogsResp
	(*SearchLogsReq)(nil),               // 31: eos.third.SearchLogsReq
	(*LogInfo)(nil),                     // 32: eos.third.LogInfo
	(*SearchLogsResp)(nil),              // 33: eos.third.SearchLogsResp
	nil,                                 // 34: eos.third.AccessURLReq.QueryEntry
	nil,                                 // 35: eos.third.InitiateFormDataResp.FormDataEntry
	(*sdkws.RequestPagination)(nil),     // 36: eos.sdkws.RequestPagination
}
var file_third_third_proto_depIdxs = []int32{
	0,  // 0: eos.third.SignPart.query:type_name -> eos.third.KeyValues
	0,  // 1: eos.third.SignPart.header:type_name -> eos.third.KeyValues
	0,  // 2: eos.third.AuthSignParts.query:type_name -> eos.third.KeyValues
	0,  // 3: eos.third.AuthSignParts.header:type_name -> eos.third.KeyValues
	1,  // 4: eos.third.AuthSignParts.parts:type_name -> eos.third.SignPart
	2,  // 5: eos.third.UploadInfo.sign:type_name -> eos.third.AuthSignParts
	8,  // 6: eos.third.InitiateMultipartUploadResp.upload:type_name -> eos.third.UploadInfo
	0,  // 7: eos.third.AuthSignResp.query:type_name -> eos.third.KeyValues
	0,  // 8: eos.third.AuthSignResp.header:type_name -> eos.third.KeyValues
	1,  // 9: eos.third.AuthSignResp.parts:type_name -> eos.third.SignPart
	34, // 10: eos.third.AccessURLReq.query:type_name -> eos.third.AccessURLReq.QueryEntry
	0,  // 11: eos.third.InitiateFormDataResp.header:type_name -> eos.third.KeyValues
	35, // 12: eos.third.InitiateFormDataResp.formData:type_name -> eos.third.InitiateFormDataResp.FormDataEntry
	26, // 13: eos.third.UploadLogsReq.fileURLs:type_name -> eos.third.fileURL
	36, // 14: eos.third.SearchLogsReq.pagination:type_name -> eos.sdkws.RequestPagination
	32, // 15: eos.third.SearchLogsResp.logsInfos:type_name -> eos.third.LogInfo
	3,  // 16: eos.third.third.PartLimit:input_type -> eos.third.PartLimitReq
	5,  // 17: eos.third.third.PartSize:input_type -> eos.third.PartSizeReq
	7,  // 18: eos.third.third.InitiateMultipartUpload:input_type -> eos.third.InitiateMultipartUploadReq
	10, // 19: eos.third.third.AuthSign:input_type -> eos.third.AuthSignReq
	12, // 20: eos.third.third.CompleteMultipartUpload:input_type -> eos.third.CompleteMultipartUploadReq
	14, // 21: eos.third.third.AccessURL:input_type -> eos.third.AccessURLReq
	16, // 22: eos.third.third.InitiateFormData:input_type -> eos.third.InitiateFormDataReq
	18, // 23: eos.third.third.CompleteFormData:input_type -> eos.third.CompleteFormDataReq
	20, // 24: eos.third.third.DeleteOutdatedData:input_type -> eos.third.DeleteOutdatedDataReq
	22, // 25: eos.third.third.FcmUpdateToken:input_type -> eos.third.FcmUpdateTokenReq
	24, // 26: eos.third.third.SetAppBadge:input_type -> eos.third.SetAppBadgeReq
	27, // 27: eos.third.third.UploadLogs:input_type -> eos.third.UploadLogsReq
	29, // 28: eos.third.third.DeleteLogs:input_type -> eos.third.DeleteLogsReq
	31, // 29: eos.third.third.SearchLogs:input_type -> eos.third.SearchLogsReq
	4,  // 30: eos.third.third.PartLimit:output_type -> eos.third.PartLimitResp
	6,  // 31: eos.third.third.PartSize:output_type -> eos.third.PartSizeResp
	9,  // 32: eos.third.third.InitiateMultipartUpload:output_type -> eos.third.InitiateMultipartUploadResp
	11, // 33: eos.third.third.AuthSign:output_type -> eos.third.AuthSignResp
	13, // 34: eos.third.third.CompleteMultipartUpload:output_type -> eos.third.CompleteMultipartUploadResp
	15, // 35: eos.third.third.AccessURL:output_type -> eos.third.AccessURLResp
	17, // 36: eos.third.third.InitiateFormData:output_type -> eos.third.InitiateFormDataResp
	19, // 37: eos.third.third.CompleteFormData:output_type -> eos.third.CompleteFormDataResp
	21, // 38: eos.third.third.DeleteOutdatedData:output_type -> eos.third.DeleteOutdatedDataResp
	23, // 39: eos.third.third.FcmUpdateToken:output_type -> eos.third.FcmUpdateTokenResp
	25, // 40: eos.third.third.SetAppBadge:output_type -> eos.third.SetAppBadgeResp
	28, // 41: eos.third.third.UploadLogs:output_type -> eos.third.UploadLogsResp
	30, // 42: eos.third.third.DeleteLogs:output_type -> eos.third.DeleteLogsResp
	33, // 43: eos.third.third.SearchLogs:output_type -> eos.third.SearchLogsResp
