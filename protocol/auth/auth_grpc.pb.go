...
const (
	Auth_GetAdminToken_FullMethodName   = "/eos.auth.Auth/getAdminToken"
	Auth_GetUserToken_FullMethodName    = "/eos.auth.Auth/getUserToken"
	Auth_ForceLogout_FullMethodName     = "/eos.auth.Auth/forceLogout"
	Auth_ParseToken_FullMethodName      = "/eos.auth.Auth/parseToken"
	Auth_InvalidateToken_FullMethodName = "/eos.auth.Auth/invalidateToken"
	Auth_KickTokens_FullMethodName      = "/eos.auth.Auth/kickTokens"
)
