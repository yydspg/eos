...
const file_push_push_proto_rawDesc = "" +
	"\n" +
	"\x0fpush/push.proto\x12\beos.push\x1a\x11sdkws/sdkws.proto\"|\n" +
	"\n" +
	"PushMsgReq\x12,\n" +
	...
	"platformID\"\x16\n" +
	"\x14DelUserPushTokenResp2\x9b\x01\n" +
	"\x0ePushMsgService\x126\n" +
	"\aPushMsg\x12\x14.eos.push.PushMsgReq\x1a\x15.eos.push.PushMsgResp\x12Q\n" +
	"\x10DelUserPushToken\x12\x1d.eos.push.DelUserPushTokenReq\x1a\x1e.eos.push.DelUserPushTokenRespB\x1eZ\x1cgithub.com/eos/protocol/pushb\x06proto3"
...
var file_push_push_proto_goTypes = []any{
	(*PushMsgReq)(nil),           // 0: eos.push.PushMsgReq
	(*PushMsgResp)(nil),          // 1: eos.push.PushMsgResp
	(*DelUserPushTokenReq)(nil),  // 2: eos.push.DelUserPushTokenReq
	(*DelUserPushTokenResp)(nil), // 3: eos.push.DelUserPushTokenResp
	(*sdkws.MsgData)(nil),        // 4: eos.sdkws.MsgData
}
var file_push_push_proto_depIdxs = []int32{
	4, // 0: eos.push.PushMsgReq.msgData:type_name -> eos.sdkws.MsgData
	0, // 1: eos.push.PushMsgService.PushMsg:input_type -> eos.push.PushMsgReq
	2, // 2: eos.push.PushMsgService.DelUserPushToken:input_type -> eos.push.DelUserPushTokenReq
	1, // 3: eos.push.PushMsgService.PushMsg:output_type -> eos.push.PushMsgResp
	3, // 4: eos.push.PushMsgService.DelUserPushToken:output_type -> eos.push.DelUserPushTokenResp
