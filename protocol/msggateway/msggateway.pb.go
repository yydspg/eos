...
const file_msggateway_msggateway_proto_rawDesc = "" +
	"\n" +
	"\x1bmsggateway/msggateway.proto\x12\x0eeos.msggateway\x1a\x11sdkws/sdkws.proto\"d\n" +
	"\x10OnlinePushMsgReq\x12,\n" +
	"\amsgData\x18\x01 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\x12\"\n" +
	"\fpushToUserID\x18\x02 \x01(\tR\fpushToUserID\"P\n" +
	"\x11OnlinePushMsgResp\x12;\n" +
	"\x04resp\x18\x01 \x03(\v2'.eos.msggateway.SingleMsgToUserPlatformR\x04resp\"\x8d\x01\n" +
	"\x16SingleMsgToUserResults\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12;\n" +
	"\x04resp\x18\x02 \x03(\v2'.eos.msggateway.SingleMsgToUserPlatformR\x04resp\x12\x1e\n" +
	"\n" +
	...
	"\x19OnlineBatchPushOneMsgResp\x12R\n" +
	"\x10singlePushResult\x18\x01 \x03(\v2&.eos.msggateway.SingleMsgToUserResultsR\x10singlePushResult\"y\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xad\x04\n" +
	"\x18GetUsersOnlineStatusResp\x12\\\n" +
	"\rsuccessResult\x18\x01 \x03(\v26.eos.msggateway.GetUsersOnlineStatusResp.SuccessResultR\rsuccessResult\x12Y\n" +
	"\ffailedResult\x18\x02 \x03(\v25.eos.msggateway.GetUsersOnlineStatusResp.FailedDetailR\ffailedResult\x1a\x81\x01\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x1a\xab\x01\n" +
	"\rSuccessResult\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12j\n" +
	"\x14detailPlatformStatus\x18\x03 \x03(\v26.eos.msggateway.GetUsersOnlineStatusResp.SuccessDetailR\x14detailPlatformStatus\"\x95\x01\n" +
	"\fSingleDetail\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12U\n" +
	"\x13singlePlatformToken\x18\x03 \x03(\v2#.eos.msggateway.SinglePlatformTokenR\x13singlePlatformToken\"a\n" +
	...
	"\x1bMultiTerminalLoginCheckResp2\x83\x05\n" +
	"\n" +
	"msgGateway\x12T\n" +
	"\rOnlinePushMsg\x12 .eos.msggateway.OnlinePushMsgReq\x1a!.eos.msggateway.OnlinePushMsgResp\x12i\n" +
	"\x14GetUsersOnlineStatus\x12'.eos.msggateway.GetUsersOnlineStatusReq\x1a(.eos.msggateway.GetUsersOnlineStatusResp\x12l\n" +
	"\x15OnlineBatchPushOneMsg\x12(.eos.msggateway.OnlineBatchPushOneMsgReq\x1a).eos.msggateway.OnlineBatchPushOneMsgResp\x12v\n" +
	"\x1fSuperGroupOnlineBatchPushOneMsg\x12(.eos.msggateway.OnlineBatchPushOneMsgReq\x1a).eos.msggateway.OnlineBatchPushOneMsgResp\x12Z\n" +
	"\x0fKickUserOffline\x12\".eos.msggateway.KickUserOfflineReq\x1a#.eos.msggateway.KickUserOfflineResp\x12r\n" +
	"\x17MultiTerminalLoginCheck\x12*.eos.msggateway.MultiTerminalLoginCheckReq\x1a+.eos.msggateway.MultiTerminalLoginCheckRespB$Z\"github.com/eos/protocol/msggatewayb\x06proto3"
...
var file_msggateway_msggateway_proto_goTypes = []any{
	(*OnlinePushMsgReq)(nil),                       // 0: eos.msggateway.OnlinePushMsgReq
	(*OnlinePushMsgResp)(nil),                      // 1: eos.msggateway.OnlinePushMsgResp
	(*SingleMsgToUserResults)(nil),                 // 2: eos.msggateway.SingleMsgToUserResults
	(*OnlineBatchPushOneMsgReq)(nil),               // 3: eos.msggateway.OnlineBatchPushOneMsgReq
	(*OnlineBatchPushOneMsgResp)(nil),              // 4: eos.msggateway.OnlineBatchPushOneMsgResp
	(*SingleMsgToUserPlatform)(nil),                // 5: eos.msggateway.SingleMsgToUserPlatform
	(*GetUsersOnlineStatusReq)(nil),                // 6: eos.msggateway.GetUsersOnlineStatusReq
	(*GetUsersOnlineStatusResp)(nil),               // 7: eos.msggateway.GetUsersOnlineStatusResp
	(*SingleDetail)(nil),                           // 8: eos.msggateway.SingleDetail
	(*SinglePlatformToken)(nil),                    // 9: eos.msggateway.SinglePlatformToken
	(*KickUserOfflineReq)(nil),                     // 10: eos.msggateway.KickUserOfflineReq
	(*KickUserOfflineResp)(nil),                    // 11: eos.msggateway.KickUserOfflineResp
	(*MultiTerminalLoginCheckReq)(nil),             // 12: eos.msggateway.MultiTerminalLoginCheckReq
	(*MultiTerminalLoginCheckResp)(nil),            // 13: eos.msggateway.MultiTerminalLoginCheckResp
	(*GetUsersOnlineStatusResp_SuccessDetail)(nil), // 14: eos.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	(*GetUsersOnlineStatusResp_FailedDetail)(nil),  // 15: eos.msggateway.GetUsersOnlineStatusResp.FailedDetail
	(*GetUsersOnlineStatusResp_SuccessResult)(nil), // 16: eos.msggateway.GetUsersOnlineStatusResp.SuccessResult
	(*sdkws.MsgData)(nil),                          // 17: eos.sdkws.MsgData
}
var file_msggateway_msggateway_proto_depIdxs = []int32{
	17, // 0: eos.msggateway.OnlinePushMsgReq.msgData:type_name -> eos.sdkws.MsgData
	5,  // 1: eos.msggateway.OnlinePushMsgResp.resp:type_name -> eos.msggateway.SingleMsgToUserPlatform
	5,  // 2: eos.msggateway.SingleMsgToUserResults.resp:type_name -> eos.msggateway.SingleMsgToUserPlatform
	17, // 3: eos.msggateway.OnlineBatchPushOneMsgReq.msgData:type_name -> eos.sdkws.MsgData
	2,  // 4: eos.msggateway.OnlineBatchPushOneMsgResp.singlePushResult:type_name -> eos.msggateway.SingleMsgToUserResults
	16, // 5: eos.msggateway.GetUsersOnlineStatusResp.successResult:type_name -> eos.msggateway.GetUsersOnlineStatusResp.SuccessResult
	15, // 6: eos.msggateway.GetUsersOnlineStatusResp.failedResult:type_name -> eos.msggateway.GetUsersOnlineStatusResp.FailedDetail
	9,  // 7: eos.msggateway.SingleDetail.singlePlatformToken:type_name -> eos.msggateway.SinglePlatformToken
	14, // 8: eos.msggateway.GetUsersOnlineStatusResp.SuccessResult.detailPlatformStatus:type_name -> eos.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	0,  // 9: eos.msggateway.msgGateway.OnlinePushMsg:input_type -> eos.msggateway.OnlinePushMsgReq
	6,  // 10: eos.msggateway.msgGateway.GetUsersOnlineStatus:input_type -> eos.msggateway.GetUsersOnlineStatusReq
	3,  // 11: eos.msggateway.msgGateway.OnlineBatchPushOneMsg:input_type -> eos.msggateway.OnlineBatchPushOneMsgReq
	3,  // 12: eos.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:input_type -> eos.msggateway.OnlineBatchPushOneMsgReq
	10, // 13: eos.msggateway.msgGateway.KickUserOffline:input_type -> eos.msggateway.KickUserOfflineReq
	12, // 14: eos.msggateway.msgGateway.MultiTerminalLoginCheck:input_type -> eos.msggateway.MultiTerminalLoginCheckReq
	1,  // 15: eos.msggateway.msgGateway.OnlinePushMsg:output_type -> eos.msggateway.OnlinePushMsgResp
	7,  // 16: eos.msggateway.msgGateway.GetUsersOnlineStatus:output_type -> eos.msggateway.GetUsersOnlineStatusResp
	4,  // 17: eos.msggateway.msgGateway.OnlineBatchPushOneMsg:output_type -> eos.msggateway.OnlineBatchPushOneMsgResp
	4,  // 18: eos.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:output_type -> eos.msggateway.OnlineBatchPushOneMsgResp
	11, // 19: eos.msggateway.msgGateway.KickUserOffline:output_type -> eos.msggateway.KickUserOfflineResp
	13, // 20: eos.msggateway.msgGateway.MultiTerminalLoginCheck:output_type -> eos.msggateway.MultiTerminalLoginCheckResp
