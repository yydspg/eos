...
type GetSeqMessageReq struct {
	...
	Order         sdkws.PullOrder        `protobuf:"varint,3,opt,name=order,proto3,enum=eos.sdkws.PullOrder" json:"order"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_msg_msg_proto_rawDesc = "" +
	"\n" +
	"\rmsg/msg.proto\x12\aeos.msg\x1a\x1fconversation/conversation.proto\x1a\x11sdkws/sdkws.proto\"Q\n" +
	"\vMsgDataToMQ\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12,\n" +
	"\amsgData\x18\x02 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\";\n" +
	"\vMsgDataToDB\x12,\n" +
	"\amsgData\x18\x01 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\"g\n" +
	"\x0fPushMsgDataToMQ\x12,\n" +
	"\amsgData\x18\x01 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\"\x84\x01\n" +
	"\x12MsgDataToMongoByMQ\x12\x18\n" +
	"\alastSeq\x18\x01 \x01(\x03R\alastSeq\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\x12,\n" +
	"\amsgData\x18\x03 \x03(\v2\x12.eos.sdkws.MsgDataR\amsgData\",\n" +
	...
	"\n" +
	"SendMsgReq\x12,\n" +
	"\amsgData\x18\x03 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\"\x99\x01\n" +
	"\vSendMsgResp\x12 \n" +
	...
	"\x06modify\x18\x04 \x01(\v2\x12.eos.sdkws.MsgDataR\x06modify\"@\n" +
	"\x10SendSimpleMsgReq\x12,\n" +
	"\amsgData\x18\x03 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\"\x9f\x01\n" +
	...
	"\bmessages\x18\x01 \x03(\v2\x12.eos.sdkws.MsgDataR\bmessages\x12&\n" +
	...
	"IsSyncSelf\x12 \n" +
	"\vIsSyncOther\x18\x04 \x01(\bR\vIsSyncOther\"\x9a\x01\n" +
	...
	"\rdeleteSyncOpt\x18\x03 \x01(\v2\x16.eos.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x1b\n" +
	"\x19ClearConversationsMsgResp\"j\n" +
	"\x12UserClearAllMsgReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12<\n" +
	"\rdeleteSyncOpt\x18\x03 \x01(\v2\x16.eos.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x15\n" +
	"\x13UserClearAllMsgResp\"\xa1\x01\n" +
	"\rDeleteMsgsReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x12\n" +
	"\x04seqs\x18\x02 \x03(\x03R\x04seqs\x12\x16\n" +
	"\x06userID\x18\x03 \x01(\tR\x06userID\x12<\n" +
	"\rdeleteSyncOpt\x18\x04 \x01(\v2\x16.eos.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x10\n" +
	"\x0eDeleteMsgsResp\"^\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12(\n" +
	"\x0fconversationIDs\x18\x02 \x03(\tR\x0fconversationIDs\"\x88\x01\n" +
	"\fSeqsInfoResp\x12<\n" +
	"\amaxSeqs\x18\x01 \x03(\v2\".eos.msg.SeqsInfoResp.MaxSeqsEntryR\amaxSeqs\x1a:\n" +
	"\fMaxSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xce\x01\n" +
	"\x1aGetMsgByConversationIDsReq\x12(\n" +
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs\x12J\n" +
	"\amaxSeqs\x18\x02 \x03(\v20.eos.msg.GetMsgByConversationIDsReq.MaxSeqsEntryR\amaxSeqs\x1a:\n" +
	"\fMaxSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xbe\x01\n" +
	"\x1bGetMsgByConversationIDsResp\x12N\n" +
	"\bmsgDatas\x18\x01 \x03(\v22.eos.msg.GetMsgByConversationIDsResp.MsgDatasEntryR\bmsgDatas\x1aO\n" +
	"\rMsgDatasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.eos.sdkws.MsgDataR\x05value:\x028\x01\"B\n" +
	...
	"\x04seqs\x18\x01 \x03(\v27.eos.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntryR\x04seqs\x1aF\n" +
	"\tSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12#\n" +
	"\x05value\x18\x02 \x01(\v2\r.eos.msg.SeqsR\x05value:\x028\x01\"\xa0\x01\n" +
	...
	"\n" +
	"pagination\x18\x05 \x01(\v2\x1c.eos.sdkws.RequestPaginationR\n" +
	"pagination\"K\n" +
	"\n" +
	"ActiveUser\x12'\n" +
	"\x04user\x18\x01 \x01(\v2\x13.eos.sdkws.UserInfoR\x04user\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"\xff\x01\n" +
	"\x11GetActiveUserResp\x12\x1a\n" +
	"\bmsgCount\x18\x01 \x01(\x03R\bmsgCount\x12\x1c\n" +
	"\tuserCount\x18\x02 \x01(\x03R\tuserCount\x12G\n" +
	"\tdateCount\x18\x03 \x03(\v2).eos.msg.GetActiveUserResp.DateCountEntryR\tdateCount\x12)\n" +
	"\x05users\x18\x04 \x03(\v2\x13.eos.msg.ActiveUserR\x05users\x1a<\n" +
	...
	"\n" +
	"pagination\x18\x04 \x01(\v2\x1c.eos.sdkws.RequestPaginationR\n" +
	"pagination\"O\n" +
	"\vActiveGroup\x12*\n" +
	"\x05group\x18\x01 \x01(\v2\x14.eos.sdkws.GroupInfoR\x05group\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"\x86\x02\n" +
	"\x12GetActiveGroupResp\x12\x1a\n" +
	"\bmsgCount\x18\x01 \x01(\x03R\bmsgCount\x12\x1e\n" +
	"\n" +
	"groupCount\x18\x02 \x01(\x03R\n" +
	"groupCount\x12H\n" +
	"\tdateCount\x18\x03 \x03(\v2*.eos.msg.GetActiveGroupResp.DateCountEntryR\tdateCount\x12,\n" +
	"\x06groups\x18\x04 \x03(\v2\x14.eos.msg.ActiveGroupR\x06groups\x1a<\n" +
	"\x0eDateCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\n" +
	"pagination\x18\x06 \x01(\v2\x1c.eos.sdkws.RequestPaginationR\n" +
	"pagination\"Y\n" +
	"\rSearchChatLog\x12*\n" +
	"\achatLog\x18\x01 \x01(\v2\x10.eos.msg.ChatLogR\achatLog\x12\x1c\n" +
	"\tisRevoked\x18\x02 \x01(\bR\tisRevoked\"]\n" +
	"\x0fSearchedMsgData\x12,\n" +
	"\amsgData\x18\x01 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\x12\x1c\n" +
	"\tisRevoked\x18\x02 \x01(\bR\tisRevoked\"i\n" +
	"\x11SearchMessageResp\x122\n" +
	"\bchatLogs\x18\x01 \x03(\v2\x16.eos.msg.SearchChatLogR\bchatLogs\x12 \n" +
	...
	"groupOwner\x12\x1c\n" +
	"\tgroupType\x18\x17 \x01(\x05R\tgroupType\"c\n" +
	"\x13batchSendMessageReq\x12\x1e\n" +
	"\n" +
	"recvIDList\x18\x01 \x03(\tR\n" +
	"recvIDList\x12,\n" +
	"\amsgData\x18\x02 \x01(\v2\x12.eos.sdkws.MsgDataR\amsgData\"\x16\n" +
	...
	"serverTime\"S\n" +
	"\vClearMsgReq\x12D\n" +
	"\rconversations\x18\x01 \x03(\v2\x1e.eos.conversation.ConversationR\rconversations\"\x0e\n" +
	"\fClearMsgResp\"E\n" +
	...
	"\x04seqs\x18\x03 \x03(\x03R\x04seqs\"\x97\x01\n" +
	"\x10GetSeqMessageReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12?\n" +
	"\rconversations\x18\x02 \x03(\v2\x19.eos.msg.ConversationSeqsR\rconversations\x12*\n" +
	"\x05order\x18\x03 \x01(\x0e2\x14.eos.sdkws.PullOrderR\x05order\"\xd3\x02\n" +
	"\x11GetSeqMessageResp\x128\n" +
	"\x04msgs\x18\x01 \x03(\v2$.eos.msg.GetSeqMessageResp.MsgsEntryR\x04msgs\x12\\\n" +
	"\x10notificationMsgs\x18\x02 \x03(\v20.eos.msg.GetSeqMessageResp.NotificationMsgsEntryR\x10notificationMsgs\x1aL\n" +
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\x1aX\n" +
	"\x15NotificationMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.eos.sdkws.PullMsgsR\x05value:\x028\x01\"Z\n" +
	...
	"\rconversations\x18\x01 \x03(\v2\x1b.eos.msg.ActiveConversationR\rconversations\"\x80\x01\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12(\n" +
	"\x0fconversationIDs\x18\x02 \x03(\tR\x0fconversationIDs\"\x9c\x01\n" +
	"\x12GetLastMessageResp\x129\n" +
	"\x04msgs\x18\x01 \x03(\v2%.eos.msg.GetLastMessageResp.MsgsEntryR\x04msgs\x1aK\n" +
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.eos.sdkws.MsgDataR\x05value:\x028\x012\xc1\x15\n" +
	"\x03msg\x12>\n" +
	"\tGetMaxSeq\x12\x17.eos.sdkws.GetMaxSeqReq\x1a\x18.eos.sdkws.GetMaxSeqResp\x12;\n" +
	"\n" +
	"GetMaxSeqs\x12\x16.eos.msg.GetMaxSeqsReq\x1a\x15.eos.msg.SeqsInfoResp\x12C\n" +
	"\x0eGetHasReadSeqs\x12\x1a.eos.msg.GetHasReadSeqsReq\x1a\x15.eos.msg.SeqsInfoResp\x12d\n" +
	"\x17GetMsgByConversationIDs\x12#.eos.msg.GetMsgByConversationIDsReq\x1a$.eos.msg.GetMsgByConversationIDsResp\x12^\n" +
	"\x15GetConversationMaxSeq\x12!.eos.msg.GetConversationMaxSeqReq\x1a\".eos.msg.GetConversationMaxSeqResp\x12V\n" +
	"\x11PullMessageBySeqs\x12\x1f.eos.sdkws.PullMessageBySeqsReq\x1a .eos.sdkws.PullMessageBySeqsResp\x12F\n" +
	"\rGetSeqMessage\x12\x19.eos.msg.GetSeqMessageReq\x1a\x1a.eos.msg.GetSeqMessageResp\x12F\n" +
	"\rSearchMessage\x12\x19.eos.msg.SearchMessageReq\x1a\x1a.eos.msg.SearchMessageResp\x124\n" +
	"\aSendMsg\x12\x13.eos.msg.SendMsgReq\x1a\x14.eos.msg.SendMsgResp\x12F\n" +
	"\rSendSimpleMsg\x12\x19.eos.msg.SendSimpleMsgReq\x1a\x1a.eos.msg.SendSimpleMsgResp\x12m\n" +
	"\x1aSetUserConversationsMinSeq\x12&.eos.msg.SetUserConversationsMinSeqReq\x1a'.eos.msg.SetUserConversationsMinSeqResp\x12^\n" +
	"\x15ClearConversationsMsg\x12!.eos.msg.ClearConversationsMsgReq\x1a\".eos.msg.ClearConversationsMsgResp\x12L\n" +
	"\x0fUserClearAllMsg\x12\x1b.eos.msg.UserClearAllMsgReq\x1a\x1c.eos.msg.UserClearAllMsgResp\x12=\n" +
	"\n" +
	"DeleteMsgs\x12\x16.eos.msg.DeleteMsgsReq\x1a\x17.eos.msg.DeleteMsgsResp\x12a\n" +
	"\x16DeleteMsgPhysicalBySeq\x12\".eos.msg.DeleteMsgPhysicalBySeqReq\x1a#.eos.msg.DeleteMsgPhysicalBySeqResp\x12R\n" +
	"\x11DeleteMsgPhysical\x12\x1d.eos.msg.DeleteMsgPhysicalReq\x1a\x1e.eos.msg.DeleteMsgPhysicalResp\x12O\n" +
	"\x10SetSendMsgStatus\x12\x1c.eos.msg.SetSendMsgStatusReq\x1a\x1d.eos.msg.SetSendMsgStatusResp\x12O\n" +
	"\x10GetSendMsgStatus\x12\x1c.eos.msg.GetSendMsgStatusReq\x1a\x1d.eos.msg.GetSendMsgStatusResp\x12:\n" +
	"\tRevokeMsg\x12\x15.eos.msg.RevokeMsgReq\x1a\x16.eos.msg.RevokeMsgResp\x12I\n" +
	"\x0eMarkMsgsAsRead\x12\x1a.eos.msg.MarkMsgsAsReadReq\x1a\x1b.eos.msg.MarkMsgsAsReadResp\x12a\n" +
	"\x16MarkConversationAsRead\x12\".eos.msg.MarkConversationAsReadReq\x1a#.eos.msg.MarkConversationAsReadResp\x12j\n" +
	"\x19SetConversationHasReadSeq\x12%.eos.msg.SetConversationHasReadSeqReq\x1a&.eos.msg.SetConversationHasReadSeqResp\x12\x7f\n" +
	" GetConversationsHasReadAndMaxSeq\x12,.eos.msg.GetConversationsHasReadAndMaxSeqReq\x1a-.eos.msg.GetConversationsHasReadAndMaxSeqResp\x12F\n" +
	"\rGetActiveUser\x12\x19.eos.msg.GetActiveUserReq\x1a\x1a.eos.msg.GetActiveUserResp\x12I\n" +
	"\x0eGetActiveGroup\x12\x1a.eos.msg.GetActiveGroupReq\x1a\x1b.eos.msg.GetActiveGroupResp\x12F\n" +
	"\rGetServerTime\x12\x19.eos.msg.GetServerTimeReq\x1a\x1a.eos.msg.GetServerTimeResp\x127\n" +
	"\bClearMsg\x12\x14.eos.msg.ClearMsgReq\x1a\x15.eos.msg.ClearMsgResp\x12C\n" +
	"\fDestructMsgs\x12\x18.eos.msg.DestructMsgsReq\x1a\x19.eos.msg.DestructMsgsResp\x12^\n" +
	"\x15GetActiveConversation\x12!.eos.msg.GetActiveConversationReq\x1a\".eos.msg.GetActiveConversationResp\x12j\n" +
	"\x19SetUserConversationMaxSeq\x12%.eos.msg.SetUserConversationMaxSeqReq\x1a&.eos.msg.SetUserConversationMaxSeqResp\x12j\n" +
	"\x19SetUserConversationMinSeq\x12%.eos.msg.SetUserConversationMinSeqReq\x1a&.eos.msg.SetUserConversationMinSeqResp\x12d\n" +
	"\x17GetLastMessageSeqByTime\x12#.eos.msg.GetLastMessageSeqByTimeReq\x1a$.eos.msg.GetLastMessageSeqByTimeResp\x12I\n" +
	"\x0eGetLastMessage\x12\x1a.eos.msg.GetLastMessageReq\x1a\x1b.eos.msg.GetLastMessageRespB\x1dZ\x1bgithub.com/eos/protocol/msgb\x06proto3"
...
var file_msg_msg_proto_goTypes = []any{
	(*MsgDataToMQ)(nil),                          // 0: eos.msg.MsgDataToMQ
	(*MsgDataToDB)(nil),                          // 1: eos.msg.MsgDataToDB
	(*PushMsgDataToMQ)(nil),                      // 2: eos.msg.PushMsgDataToMQ
	(*MsgDataToMongoByMQ)(nil),                   // 3: eos.msg.MsgDataToMongoByMQ
	(*GetMaxAndMinSeqReq)(nil),                   // 4: eos.msg.GetMaxAndMinSeqReq
	(*GetMaxAndMinSeqResp)(nil),                  // 5: eos.msg.GetMaxAndMinSeqResp
	(*SendMsgReq)(nil),                           // 6: eos.msg.SendMsgReq
	(*SendMsgResp)(nil),                          // 7: eos.msg.SendMsgResp
	(*SendSimpleMsgReq)(nil),                     // 8: eos.msg.SendSimpleMsgReq
	(*SendSimpleMsgResp)(nil),                    // 9: eos.msg.SendSimpleMsgResp
	(*SetSendMsgStatusReq)(nil),                  // 10: eos.msg.SetSendMsgStatusReq
	(*SetSendMsgStatusResp)(nil),                 // 11: eos.msg.SetSendMsgStatusResp
	(*GetSendMsgStatusReq)(nil),                  // 12: eos.msg.GetSendMsgStatusReq
	(*GetSendMsgStatusResp)(nil),                 // 13: eos.msg.GetSendMsgStatusResp
	(*MsgDataToModifyByMQ)(nil),                  // 14: eos.msg.MsgDataToModifyByMQ
	(*DelMsgsReq)(nil),                           // 15: eos.msg.DelMsgsReq
	(*DelMsgsResp)(nil),                          // 16: eos.msg.DelMsgsResp
	(*RevokeMsgReq)(nil),                         // 17: eos.msg.RevokeMsgReq
	(*RevokeMsgResp)(nil),                        // 18: eos.msg.RevokeMsgResp
	(*MarkMsgsAsReadReq)(nil),                    // 19: eos.msg.MarkMsgsAsReadReq
	(*MarkMsgsAsReadResp)(nil),                   // 20: eos.msg.MarkMsgsAsReadResp
	(*MarkConversationAsReadReq)(nil),            // 21: eos.msg.MarkConversationAsReadReq
	(*MarkConversationAsReadResp)(nil),           // 22: eos.msg.MarkConversationAsReadResp
	(*SetConversationHasReadSeqReq)(nil),         // 23: eos.msg.SetConversationHasReadSeqReq
	(*SetConversationHasReadSeqResp)(nil),        // 24: eos.msg.SetConversationHasReadSeqResp
	(*DeleteSyncOpt)(nil),                        // 25: eos.msg.DeleteSyncOpt
	(*ClearConversationsMsgReq)(nil),             // 26: eos.msg.ClearConversationsMsgReq
	(*ClearConversationsMsgResp)(nil),            // 27: eos.msg.ClearConversationsMsgResp
	(*UserClearAllMsgReq)(nil),                   // 28: eos.msg.UserClearAllMsgReq
	(*UserClearAllMsgResp)(nil),                  // 29: eos.msg.UserClearAllMsgResp
	(*DeleteMsgsReq)(nil),                        // 30: eos.msg.DeleteMsgsReq
	(*DeleteMsgsResp)(nil),                       // 31: eos.msg.DeleteMsgsResp
	(*DeleteMsgPhysicalReq)(nil),                 // 32: eos.msg.DeleteMsgPhysicalReq
	(*DeleteMsgPhysicalResp)(nil),                // 33: eos.msg.DeleteMsgPhysicalResp
	(*DeleteMsgPhysicalBySeqReq)(nil),            // 34: eos.msg.DeleteMsgPhysicalBySeqReq
	(*DeleteMsgPhysicalBySeqResp)(nil),           // 35: eos.msg.DeleteMsgPhysicalBySeqResp
	(*GetMaxSeqsReq)(nil),                        // 36: eos.msg.GetMaxSeqsReq
	(*GetHasReadSeqsReq)(nil),                    // 37: eos.msg.GetHasReadSeqsReq
	(*SeqsInfoResp)(nil),                         // 38: eos.msg.SeqsInfoResp
	(*GetMsgByConversationIDsReq)(nil),           // 39: eos.msg.GetMsgByConversationIDsReq
	(*GetMsgByConversationIDsResp)(nil),          // 40: eos.msg.GetMsgByConversationIDsResp
	(*GetConversationMaxSeqReq)(nil),             // 41: eos.msg.GetConversationMaxSeqReq
	(*GetConversationMaxSeqResp)(nil),            // 42: eos.msg.GetConversationMaxSeqResp
	(*GetConversationsHasReadAndMaxSeqReq)(nil),  // 43: eos.msg.GetConversationsHasReadAndMaxSeqReq
	(*Seqs)(nil),                                 // 44: eos.msg.Seqs
	(*GetConversationsHasReadAndMaxSeqResp)(nil), // 45: eos.msg.GetConversationsHasReadAndMaxSeqResp
	(*GetActiveUserReq)(nil),                     // 46: eos.msg.GetActiveUserReq
	(*ActiveUser)(nil),                           // 47: eos.msg.ActiveUser
	(*GetActiveUserResp)(nil),                    // 48: eos.msg.GetActiveUserResp
	(*GetActiveGroupReq)(nil),                    // 49: eos.msg.GetActiveGroupReq
	(*ActiveGroup)(nil),                          // 50: eos.msg.ActiveGroup
	(*GetActiveGroupResp)(nil),                   // 51: eos.msg.GetActiveGroupResp
	(*SearchMessageReq)(nil),                     // 52: eos.msg.SearchMessageReq
	(*SearchChatLog)(nil),                        // 53: eos.msg.SearchChatLog
	(*SearchedMsgData)(nil),                      // 54: eos.msg.SearchedMsgData
	(*SearchMessageResp)(nil),                    // 55: eos.msg.SearchMessageResp
	(*ChatLog)(nil),                              // 56: eos.msg.ChatLog
	(*BatchSendMessageReq)(nil),                  // 57: eos.msg.batchSendMessageReq
	(*BatchSendMessageResp)(nil),                 // 58: eos.msg.batchSendMessageResp
	(*GetServerTimeReq)(nil),                     // 59: eos.msg.GetServerTimeReq
	(*GetServerTimeResp)(nil),                    // 60: eos.msg.GetServerTimeResp
	(*ClearMsgReq)(nil),                          // 61: eos.msg.ClearMsgReq
	(*ClearMsgResp)(nil),                         // 62: eos.msg.ClearMsgResp
	(*DestructMsgsReq)(nil),                      // 63: eos.msg.DestructMsgsReq
	(*DestructMsgsResp)(nil),                     // 64: eos.msg.DestructMsgsResp
	(*SetUserConversationsMinSeqReq)(nil),        // 65: eos.msg.SetUserConversationsMinSeqReq
	(*SetUserConversationsMinSeqResp)(nil),       // 66: eos.msg.SetUserConversationsMinSeqResp
	(*ConversationSeqs)(nil),                     // 67: eos.msg.ConversationSeqs
	(*GetSeqMessageReq)(nil),                     // 68: eos.msg.GetSeqMessageReq
	(*GetSeqMessageResp)(nil),                    // 69: eos.msg.GetSeqMessageResp
	(*GetActiveConversationReq)(nil),             // 70: eos.msg.GetActiveConversationReq
	(*ActiveConversation)(nil),                   // 71: eos.msg.ActiveConversation
	(*GetActiveConversationResp)(nil),            // 72: eos.msg.GetActiveConversationResp
	(*SetUserConversationMaxSeqReq)(nil),         // 73: eos.msg.SetUserConversationMaxSeqReq
	(*SetUserConversationMaxSeqResp)(nil),        // 74: eos.msg.SetUserConversationMaxSeqResp
	(*SetUserConversationMinSeqReq)(nil),         // 75: eos.msg.SetUserConversationMinSeqReq
	(*SetUserConversationMinSeqResp)(nil),        // 76: eos.msg.SetUserConversationMinSeqResp
	(*GetLastMessageSeqByTimeReq)(nil),           // 77: eos.msg.GetLastMessageSeqByTimeReq
	(*GetLastMessageSeqByTimeResp)(nil),          // 78: eos.msg.GetLastMessageSeqByTimeResp
	(*GetLastMessageReq)(nil),                    // 79: eos.msg.GetLastMessageReq
	(*GetLastMessageResp)(nil),                   // 80: eos.msg.GetLastMessageResp
	nil,                                          // 81: eos.msg.SeqsInfoResp.MaxSeqsEntry
	nil,                                          // 82: eos.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	nil,                                          // 83: eos.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	nil,                                          // 84: eos.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	nil,                                          // 85: eos.msg.GetActiveUserResp.DateCountEntry
	nil,                                          // 86: eos.msg.GetActiveGroupResp.DateCountEntry
	nil,                                          // 87: eos.msg.GetSeqMessageResp.MsgsEntry
	nil,                                          // 88: eos.msg.GetSeqMessageResp.NotificationMsgsEntry
	nil,                                          // 89: eos.msg.GetLastMessageResp.MsgsEntry
	(*sdkws.MsgData)(nil),                        // 90: eos.sdkws.MsgData
	(*sdkws.RequestPagination)(nil),              // 91: eos.sdkws.RequestPagination
	(*sdkws.UserInfo)(nil),                       // 92: eos.sdkws.UserInfo
	(*sdkws.GroupInfo)(nil),                      // 93: eos.sdkws.GroupInfo
	(*conversation.Conversation)(nil),            // 94: eos.conversation.Conversation
	(sdkws.PullOrder)(0),                         // 95: eos.sdkws.PullOrder
	(*sdkws.PullMsgs)(nil),                       // 96: eos.sdkws.PullMsgs
	(*sdkws.GetMaxSeqReq)(nil),                   // 97: eos.sdkws.GetMaxSeqReq
	(*sdkws.PullMessageBySeqsReq)(nil),           // 98: eos.sdkws.PullMessageBySeqsReq
	(*sdkws.GetMaxSeqResp)(nil),                  // 99: eos.sdkws.GetMaxSeqResp
	(*sdkws.PullMessageBySeqsResp)(nil),          // 100: eos.sdkws.PullMessageBySeqsResp
}
var file_msg_msg_proto_depIdxs = []int32{
	90,  // 0: eos.msg.MsgDataToMQ.msgData:type_name -> eos.sdkws.MsgData
	90,  // 1: eos.msg.MsgDataToDB.msgData:type_name -> eos.sdkws.MsgData
	90,  // 2: eos.msg.PushMsgDataToMQ.msgData:type_name -> eos.sdkws.MsgData
	90,  // 3: eos.msg.MsgDataToMongoByMQ.msgData:type_name -> eos.sdkws.MsgData
	90,  // 4: eos.msg.SendMsgReq.msgData:type_name -> eos.sdkws.MsgData
	90,  // 5: eos.msg.SendMsgResp.modify:type_name -> eos.sdkws.MsgData
	90,  // 6: eos.msg.SendSimpleMsgReq.msgData:type_name -> eos.sdkws.MsgData
	90,  // 7: eos.msg.SendSimpleMsgResp.modify:type_name -> eos.sdkws.MsgData
	90,  // 8: eos.msg.MsgDataToModifyByMQ.messages:type_name -> eos.sdkws.MsgData
	25,  // 9: eos.msg.ClearConversationsMsgReq.deleteSyncOpt:type_name -> eos.msg.DeleteSyncOpt
	25,  // 10: eos.msg.UserClearAllMsgReq.deleteSyncOpt:type_name -> eos.msg.DeleteSyncOpt
	25,  // 11: eos.msg.DeleteMsgsReq.deleteSyncOpt:type_name -> eos.msg.DeleteSyncOpt
	81,  // 12: eos.msg.SeqsInfoResp.maxSeqs:type_name -> eos.msg.SeqsInfoResp.MaxSeqsEntry
	82,  // 13: eos.msg.GetMsgByConversationIDsReq.maxSeqs:type_name -> eos.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	83,  // 14: eos.msg.GetMsgByConversationIDsResp.msgDatas:type_name -> eos.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	84,  // 15: eos.msg.GetConversationsHasReadAndMaxSeqResp.seqs:type_name -> eos.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	91,  // 16: eos.msg.GetActiveUserReq.pagination:type_name -> eos.sdkws.RequestPagination
	92,  // 17: eos.msg.ActiveUser.user:type_name -> eos.sdkws.UserInfo
	85,  // 18: eos.msg.GetActiveUserResp.dateCount:type_name -> eos.msg.GetActiveUserResp.DateCountEntry
	47,  // 19: eos.msg.GetActiveUserResp.users:type_name -> eos.msg.ActiveUser
	91,  // 20: eos.msg.GetActiveGroupReq.pagination:type_name -> eos.sdkws.RequestPagination
	93,  // 21: eos.msg.ActiveGroup.group:type_name -> eos.sdkws.GroupInfo
	86,  // 22: eos.msg.GetActiveGroupResp.dateCount:type_name -> eos.msg.GetActiveGroupResp.DateCountEntry
	50,  // 23: eos.msg.GetActiveGroupResp.groups:type_name -> eos.msg.ActiveGroup
	91,  // 24: eos.msg.SearchMessageReq.pagination:type_name -> eos.sdkws.RequestPagination
	56,  // 25: eos.msg.SearchChatLog.chatLog:type_name -> eos.msg.ChatLog
	90,  // 26: eos.msg.SearchedMsgData.msgData:type_name -> eos.sdkws.MsgData
	53,  // 27: eos.msg.SearchMessageResp.chatLogs:type_name -> eos.msg.SearchChatLog
	90,  // 28: eos.msg.batchSendMessageReq.msgData:type_name -> eos.sdkws.MsgData
	94,  // 29: eos.msg.ClearMsgReq.conversations:type_name -> eos.conversation.Conversation
	67,  // 30: eos.msg.GetSeqMessageReq.conversations:type_name -> eos.msg.ConversationSeqs
	95,  // 31: eos.msg.GetSeqMessageReq.order:type_name -> eos.sdkws.PullOrder
	87,  // 32: eos.msg.GetSeqMessageResp.msgs:type_name -> eos.msg.GetSeqMessageResp.MsgsEntry
	88,  // 33: eos.msg.GetSeqMessageResp.notificationMsgs:type_name -> eos.msg.GetSeqMessageResp.NotificationMsgsEntry
	71,  // 34: eos.msg.GetActiveConversationResp.conversations:type_name -> eos.msg.ActiveConversation
	89,  // 35: eos.msg.GetLastMessageResp.msgs:type_name -> eos.msg.GetLastMessageResp.MsgsEntry
	90,  // 36: eos.msg.GetMsgByConversationIDsResp.MsgDatasEntry.value:type_name -> eos.sdkws.MsgData
	44,  // 37: eos.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry.value:type_name -> eos.msg.Seqs
	96,  // 38: eos.msg.GetSeqMessageResp.MsgsEntry.value:type_name -> eos.sdkws.PullMsgs
	96,  // 39: eos.msg.GetSeqMessageResp.NotificationMsgsEntry.value:type_name -> eos.sdkws.PullMsgs
	90,  // 40: eos.msg.GetLastMessageResp.MsgsEntry.value:type_name -> eos.sdkws.MsgData
	97,  // 41: eos.msg.msg.GetMaxSeq:input_type -> eos.sdkws.GetMaxSeqReq
	36,  // 42: eos.msg.msg.GetMaxSeqs:input_type -> eos.msg.GetMaxSeqsReq
	37,  // 43: eos.msg.msg.GetHasReadSeqs:input_type -> eos.msg.GetHasReadSeqsReq
	39,  // 44: eos.msg.msg.GetMsgByConversationIDs:input_type -> eos.msg.GetMsgByConversationIDsReq
	41,  // 45: eos.msg.msg.GetConversationMaxSeq:input_type -> eos.msg.GetConversationMaxSeqReq
	98,  // 46: eos.msg.msg.PullMessageBySeqs:input_type -> eos.sdkws.PullMessageBySeqsReq
	68,  // 47: eos.msg.msg.GetSeqMessage:input_type -> eos.msg.GetSeqMessageReq
	52,  // 48: eos.msg.msg.SearchMessage:input_type -> eos.msg.SearchMessageReq
	6,   // 49: eos.msg.msg.SendMsg:input_type -> eos.msg.SendMsgReq
	8,   // 50: eos.msg.msg.SendSimpleMsg:input_type -> eos.msg.SendSimpleMsgReq
	65,  // 51: eos.msg.msg.SetUserConversationsMinSeq:input_type -> eos.msg.SetUserConversationsMinSeqReq
	26,  // 52: eos.msg.msg.ClearConversationsMsg:input_type -> eos.msg.ClearConversationsMsgReq
	28,  // 53: eos.msg.msg.UserClearAllMsg:input_type -> eos.msg.UserClearAllMsgReq
	30,  // 54: eos.msg.msg.DeleteMsgs:input_type -> eos.msg.DeleteMsgsReq
	34,  // 55: eos.msg.msg.DeleteMsgPhysicalBySeq:input_type -> eos.msg.DeleteMsgPhysicalBySeqReq
	32,  // 56: eos.msg.msg.DeleteMsgPhysical:input_type -> eos.msg.DeleteMsgPhysicalReq
	10,  // 57: eos.msg.msg.SetSendMsgStatus:input_type -> eos.msg.SetSendMsgStatusReq
	12,  // 58: eos.msg.msg.GetSendMsgStatus:input_type -> eos.msg.GetSendMsgStatusReq
	17,  // 59: eos.msg.msg.RevokeMsg:input_type -> eos.msg.RevokeMsgReq
	19,  // 60: eos.msg.msg.MarkMsgsAsRead:input_type -> eos.msg.MarkMsgsAsReadReq
	21,  // 61: eos.msg.msg.MarkConversationAsRead:input_type -> eos.msg.MarkConversationAsReadReq
	23,  // 62: eos.msg.msg.SetConversationHasReadSeq:input_type -> eos.msg.SetConversationHasReadSeqReq
	43,  // 63: eos.msg.msg.GetConversationsHasReadAndMaxSeq:input_type -> eos.msg.GetConversationsHasReadAndMaxSeqReq
	46,  // 64: eos.msg.msg.GetActiveUser:input_type -> eos.msg.GetActiveUserReq
	49,  // 65: eos.msg.msg.GetActiveGroup:input_type -> eos.msg.GetActiveGroupReq
	59,  // 66: eos.msg.msg.GetServerTime:input_type -> eos.msg.GetServerTimeReq
	61,  // 67: eos.msg.msg.ClearMsg:input_type -> eos.msg.ClearMsgReq
	63,  // 68: eos.msg.msg.DestructMsgs:input_type -> eos.msg.DestructMsgsReq
	70,  // 69: eos.msg.msg.GetActiveConversation:input_type -> eos.msg.GetActiveConversationReq
	73,  // 70: eos.msg.msg.SetUserConversationMaxSeq:input_type -> eos.msg.SetUserConversationMaxSeqReq
	75,  // 71: eos.msg.msg.SetUserConversationMinSeq:input_type -> eos.msg.SetUserConversationMinSeqReq
	77,  // 72: eos.msg.msg.GetLastMessageSeqByTime:input_type -> eos.msg.GetLastMessageSeqByTimeReq
	79,  // 73: eos.msg.msg.GetLastMessage:input_type -> eos.msg.GetLastMessageReq
	99,  // 74: eos.msg.msg.GetMaxSeq:output_type -> eos.sdkws.GetMaxSeqResp
	38,  // 75: eos.msg.msg.GetMaxSeqs:output_type -> eos.msg.SeqsInfoResp
	38,  // 76: eos.msg.msg.GetHasReadSeqs:output_type -> eos.msg.SeqsInfoResp
	40,  // 77: eos.msg.msg.GetMsgByConversationIDs:output_type -> eos.msg.GetMsgByConversationIDsResp
	42,  // 78: eos.msg.msg.GetConversationMaxSeq:output_type -> eos.msg.GetConversationMaxSeqResp
	100, // 79: eos.msg.msg.PullMessageBySeqs:output_type -> eos.sdkws.PullMessageBySeqsResp
	69,  // 80: eos.msg.msg.GetSeqMessage:output_type -> eos.msg.GetSeqMessageResp
	55,  // 81: eos.msg.msg.SearchMessage:output_type -> eos.msg.SearchMessageResp
	7,   // 82: eos.msg.msg.SendMsg:output_type -> eos.msg.SendMsgResp
	9,   // 83: eos.msg.msg.SendSimpleMsg:output_type -> eos.msg.SendSimpleMsgResp
	66,  // 84: eos.msg.msg.SetUserConversationsMinSeq:output_type -> eos.msg.SetUserConversationsMinSeqResp
	27,  // 85: eos.msg.msg.ClearConversationsMsg:output_type -> eos.msg.ClearConversationsMsgResp
	29,  // 86: eos.msg.msg.UserClearAllMsg:output_type -> eos.msg.UserClearAllMsgResp
	31,  // 87: eos.msg.msg.DeleteMsgs:output_type -> eos.msg.DeleteMsgsResp
	35,  // 88: eos.msg.msg.DeleteMsgPhysicalBySeq:output_type -> eos.msg.DeleteMsgPhysicalBySeqResp
	33,  // 89: eos.msg.msg.DeleteMsgPhysical:output_type -> eos.msg.DeleteMsgPhysicalResp
	11,  // 90: eos.msg.msg.SetSendMsgStatus:output_type -> eos.msg.SetSendMsgStatusResp
	13,  // 91: eos.msg.msg.GetSendMsgStatus:output_type -> eos.msg.GetSendMsgStatusResp
	18,  // 92: eos.msg.msg.RevokeMsg:output_type -> eos.msg.RevokeMsgResp
	20,  // 93: eos.msg.msg.MarkMsgsAsRead:output_type -> eos.msg.MarkMsgsAsReadResp
	22,  // 94: eos.msg.msg.MarkConversationAsRead:output_type -> eos.msg.MarkConversationAsReadResp
	24,  // 95: eos.msg.msg.SetConversationHasReadSeq:output_type -> eos.msg.SetConversationHasReadSeqResp
	45,  // 96: eos.msg.msg.GetConversationsHasReadAndMaxSeq:output_type -> eos.msg.GetConversationsHasReadAndMaxSeqResp
	48,  // 97: eos.msg.msg.GetActiveUser:output_type -> eos.msg.GetActiveUserResp
	51,  // 98: eos.msg.msg.GetActiveGroup:output_type -> eos.msg.GetActiveGroupResp
	60,  // 99: eos.msg.msg.GetServerTime:output_type -> eos.msg.GetServerTimeResp
	62,  // 100: eos.msg.msg.ClearMsg:output_type -> eos.msg.ClearMsgResp
	64,  // 101: eos.msg.msg.DestructMsgs:output_type -> eos.msg.DestructMsgsResp
	72,  // 102: eos.msg.msg.GetActiveConversation:output_type -> eos.msg.GetActiveConversationResp
	74,  // 103: eos.msg.msg.SetUserConversationMaxSeq:output_type -> eos.msg.SetUserConversationMaxSeqResp
	76,  // 104: eos.msg.msg.SetUserConversationMinSeq:output_type -> eos.msg.SetUserConversationMinSeqResp
	78,  // 105: eos.msg.msg.GetLastMessageSeqByTime:output_type -> eos.msg.GetLastMessageSeqByTimeResp
	80,  // 106: eos.msg.msg.GetLastMessage:output_type -> eos.msg.GetLastMessageResp
